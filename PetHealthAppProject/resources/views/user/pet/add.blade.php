...
<body class="bg-main-2">
    ...
    <div class="main-box flex-vert bg-main">
        ...
        <form class="flex-vert m-auto w-75 h-75" action="{{ route('user.pet.create-process') }}" method="POST">
            @csrf
            <div class="flex-vert">
                <label for="photo_address" class="mx-auto mb-1 fs-6 txt-user-S upload-button bg-pic-ex">
                    <i class="m-auto bi bi-upload"></i>
                </label>
