...
class Battle
{
    ...
    private function judge(): string
    {
        if ($this->first === $this->second) {
            return '引き分け';
        }elseif ($this->first === 'グー' && $this->second === 'チョキ') {
            return '勝ち';
        }elseif ($this->first === 'グー' && $this->second === 'パー') {
            return '負け';
        }elseif ($this->first === 'チョキ' && $this->second === 'グー') {
            return '負け';
        }elseif ($this->first === 'チョキ' && $this->second === 'パー') {
            return '勝ち';
        }elseif ($this->first === 'パー' && $this->second === 'グー') {
            return '勝ち';
        }elseif ($this->first === 'パー' && $this->second === 'チョキ') {
            return '負け';
        }
    }
...
if (!empty($_POST['last_name']) && !empty($_POST['first_name']) && $_POST['choice']!=0) {
