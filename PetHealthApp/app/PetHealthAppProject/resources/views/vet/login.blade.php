...
<body class="bg-main">
    ...
    <div class="pre-main-box flex-vert bg-main">
        <div class="mx-auto mb-auto">
            <h1 class="txt-vet-M fw-bold display-4 text-center">獣医師<br>ログイン</h1>
        </div>
        <form class="flex-vert mx-auto w-75 h-75" action="{{ route('vet.login-process') }}" method="POST">
            @csrf
            <div class="mt-auto">
            ...
            <div class="mt-auto text-center">
                ...
                @endif
                <button class="py-1 fs-4 rounded-3 btn-vet-action" type="submit">ログイン</button>
            </div>
        </form>
        <div class="mx-auto mt-3">
            <p class="mb-1 fs-6 txt-accent-S text-center">初めて利用する方</p>
            <a class="py-1 fs-4 rounded-3 btn-accent-action" href="{{ route('vet.create') }}">新規登録</a>
        </div>
    </div>
